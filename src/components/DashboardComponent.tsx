    ...
    return (
        <>
            <Container fluid className={isDarkTheme ? 'darkbg darktxt px-0' : 'lightbg lighttxt px-0'}>
                <Row className={`border-0 rounded-b-3xl m-0 ${isMobile ? 'margincard2' : 'margincard1'} ${isDarkTheme ? 'darkpattern position-relative' : 'lightpattern '}`}>
                    <Col lg={6} className={`${isMobile ? 'pt-1 px-2' : 'pt-3 px-3 pb-4'}`}>
                    ...
                    <Col lg={6} className={`${isMobile ? 'px-0' : 'px-0 pt-5'}`}>
                        <Row className='gx-0 xs:px-4'>
                            <Col xs={6} lg={10} className='pt-1'>
                                <p className='lg:text-end pe-3 fw2'>
                                    Dark Mode
                                </p>
                            </Col>
                            ...
                            <Row className='mx-3'>
                                <Col className={isDarkTheme ? "p-2 facecard" : "p-2 facecardlight"}>
                                    ...
                                    <Row className='text-center'>
                                        {/* <Col lg={5} className='svg-container2 pt-2 px-0 pe-1'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                                        </Col>
                                        <Col lg={7} className='svg-container3 text-left px-0 ps-1'>
                                            <p className='tlv tracking-wider green'>
                                                12 Today
                                            </p>
                                        </Col> */}
                                        <Col className='svg-container2 pt-4 pb-3'>
                        ...
                        <Col lg={3} sm={12} className='pb-5'>
                            <Row className='mx-3'>
                                <Col className={isDarkTheme ? "instapad instacard" : "instapad instacardlight"}>
                                    <Row>
                                        <Col lg={5} className='svg-container px-0 pe-2 pt-4 pb-3'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"><defs><linearGradient id="a" x1="100%" x2="0%" y1="0%" y2="100%"><stop offset="0%" stop-color="#DF4896" /><stop offset="50.913%" stop-color="#EE877E" /><stop offset="100%" stop-color="#FDC366" /></linearGradient></defs><path fill="url(#a)" d="M10 1.802c2.67 0 2.987.01 4.042.059 2.71.123 3.975 1.409 4.099 4.099.048 1.054.057 1.37.057 4.04 0 2.672-.01 2.988-.057 4.042-.124 2.687-1.387 3.975-4.1 4.099-1.054.048-1.37.058-4.041.058-2.67 0-2.987-.01-4.04-.058-2.717-.124-3.977-1.416-4.1-4.1-.048-1.054-.058-1.37-.058-4.041 0-2.67.01-2.986.058-4.04.124-2.69 1.387-3.977 4.1-4.1 1.054-.048 1.37-.058 4.04-.058zM10 0C7.284 0 6.944.012 5.878.06 2.246.227.228 2.242.06 5.877.01 6.944 0 7.284 0 10s.012 3.057.06 4.123c.167 3.632 2.182 5.65 5.817 5.817 1.067.048 1.407.06 4.123.06s3.057-.012 4.123-.06c3.629-.167 5.652-2.182 5.816-5.817.05-1.066.061-1.407.061-4.123s-.012-3.056-.06-4.122C19.777 2.249 17.76.228 14.124.06 13.057.01 12.716 0 10 0zm0 4.865a5.135 5.135 0 100 10.27 5.135 5.135 0 000-10.27zm0 8.468a3.333 3.333 0 110-6.666 3.333 3.333 0 010 6.666zm5.338-9.87a1.2 1.2 0 100 2.4 1.2 1.2 0 000-2.4z" /></svg>                                        </Col>
                                        <Col lg={7} className='attxt fw2 px-0 pt-4 pb-3 tracking-wider'>
                                            @realnathanf
                                        </Col>
                                    </Row>
                                    <Row className='text-center pb-4'>
                                    ...
                                    <Row className='text-center'>
                                        <Col lg={4} className='svg-container2 pt-2 px-0'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                                        </Col>
                                        <Col lg={8} className='svg-container3 text-left px-0 ps-2'>
                                            <p className='tlv tracking-wider green'>
                                                1099 Today
                                            </p>
                                        </Col>
                        ...
                        <Col lg={3} sm={12} className='pb-5'>
                            <Row className='mx-3'>
                                <Col className={isDarkTheme ? "p-2 tubecard" : "p-2 tubecardlight"}>
                                    ...
                                    <Row className='text-center'>
                                        <Col lg={5} className='svg-container2 pt-2 px-0 pe-2'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z" /></svg>                                        </Col>
                                        <Col lg={7} className='svg-container3 text-left px-0'>
                                            <p className='tlv tracking-wider red'>
                                                144 Today
                                            </p>
                                        </Col>
                                    </Row>
        ...
        // <div className={isDarkTheme ? 'darkbg darktxt' : 'lightbg lighttxt'}>
        //     <div className={isDarkTheme ? 'darkpattern border-0 rounded-b-3xl' : 'lightpattern border-0 rounded-b-3xl'}></div>
